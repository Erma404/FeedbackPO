...
const MOCK_KANBAN = [
  {
    ...
    criteres_acceptation: ["Export CSV et XLSX disponibles depuis le dashboard", "Données filtrables par période, équipe et produit", "Format compatible Power BI et Google Sheets"],
  ...
  },
  {
    ...
    criteres_acceptation: ["Bouton 'Exporter' visible sur le dashboard", "Formats : CSV, XLSX, JSON", "Export en moins de 3 secondes"],
  ...
  },
  {
    ...
    criteres_acceptation: ["Email automatique chaque lundi à 8h", "Contient chiffre clé, évolution N-1, top 3 alertes", "Désabonnement en 1 clic"],
  ...
  },
  {
    ...
    criteres_acceptation: ["Interface responsive iOS/Android", "Chargement < 2s en 4G", "Affichage des 5 KPIs principaux"],
  ...
  },
  {
    ...
    criteres_acceptation: ["Interface de sélection des colonnes par profil", "Sauvegarde de templates nommés", "3 templates prédéfinis fournis"],
  ...
  },
  {
    ...
    criteres_acceptation: ["Export CSV encodé en UTF-8 avec BOM", "Caractères accentués affichés correctement dans Excel et Google Sheets", "Test sur Windows et macOS"],
  ...
  },
  {
    ...
    criteres_acceptation: ["Benchmark des 3 options sur coût, déliverabilité et API", "Proof of concept avec l'option retenue", "Estimation de la feature mise à jour"],
